...
with open('full_dialog_text.txt', 'r', encoding="utf-8") as reader:
...
stop_time = None
pokemon_names_json = {}
with open('full_dialog_text_silences.txt', 'r', encoding="utf-8") as reader:
...
#print(pokemon_names[15:25])

#print(pokemon_names[25:35])
print(pokemon_names[100:125])
