...
with open('full_attacks_names.txt', 'r', encoding="utf-8") as reader:
    # Alternatively you could use
    line = reader.readline().strip()
    data = {'name': line}
    attack_names.append(data)
...
stop_time = None
attack_names_json = {}
with open('full_attacks_names_silences.txt', 'r', encoding="utf-8") as reader:
    # Further file processing goes here
    # Read and print the entire file line by line
    while i < len(attack_names) - 1:  # The EOF char is an empty string
...
#        print(silence_stop_duration_line)
    ...
    # For last item only
    # Set manually
    data = attack_names[len(attack_names)-1]
    start_time_mod = 0.1
    data['start'] = start_time - start_time_mod
    data['stop'] = -1
    data['distance'] = 1.29
...
print(attack_names[25:35])
#print(attack_names[783:785])
#print(attack_names[709:713])

#print(json.dumps(attack_names_json))
